...
SUBURBS = [
    {
        ...
        "why_local": ("Bairnsdale-based.", "Our own town. A Bairnsdale deck quote carries nothing for travel, and we can usually walk the site within a few days of you calling."),
        "faq_local": [
    ...
    },
    {
        ...
        "intro": [
            ...
            "Lakes Entrance is a standing part of our week, 35 kilometres east along the Princes Highway, and a decade of building decks on this stretch of coast has taught us which materials actually survive it. For rental owners we can sequence a deck build around booking windows so you lose as few nights as possible, and we keep the site tidy between stages.",
        ],
        "why_local": ("Built for a rental season.", "Boards that still photograph well after a summer of guests, and a frame detailed to drain rather than hold salt."),
        "faq_local": [
            ...
            ("Can you build around holiday rental bookings?",
             "Yes. Decking is noisy, dusty work, so we plan it into the gaps in your calendar and stage it to cost you the fewest nights. Between stages the deck is left safe to walk on and the site is left tidy."),
        ],
    ...
    },
    {
        ...
        "why_local": ("Canal-front experience, not theory.", "Two Paynesville builds are in our gallery, including a waterfront composite deck with a glass balustrade."),
        "faq_local": [
    ...
    },
    {
        ...
        "intro": [
            "Three kinds of house turn up in our Sale quotes and each one wants a different deck. Period homes usually want a verandah restored or rebuilt in keeping with the front of the house. Post-war brick homes tend to want a proper entertaining deck off the back where there was only ever a concrete slab. Newer estate homes want the alfresco finished properly, often with a pergola or a roofed section so the barbecue area is usable in more than three months of the year.",
            ...
            "The run from our Bairnsdale yard to Sale is about 50 minutes down the Princes Highway, and we make it often enough that it is priced as a normal job rather than a trip. What you are quoted already includes getting there and back.",
        ],
        "why_local": ("On the weekly run west.", "Getting to Sale is already inside the price, so a roofed pergola is quoted the same as a job in town."),
        "faq_local": [
            ("Do you travel to Sale for deck and pergola work?",
             "Yes. It is about 65 kilometres down the Princes Highway, near enough to an hour each way, and it is a run we make regularly. The cost of getting there is in the quoted price, not added to the invoice afterwards."),
    ...
    },
    {
        ...
        "intro": [
            ...
            "Stratford falls on the same run west as Sale, about 45 minutes from our Bairnsdale yard. A decade of these jobs has taught us to work with an old house rather than against it: keep what makes it read correctly from the street, replace what has actually failed underneath.",
        ],
        "why_local": ("Verandahs in proportion.", "On a period front the post spacing and rail heights have to be right, not just the timber underneath."),
        "faq_local": [
            ...
            ("How far is Stratford from Bairnsdale?",
             "About 55 kilometres west, 40 to 45 minutes, and it falls on the same run as Sale. Regular enough that getting there is already priced in."),
        ],
    ...
    },
    {
        ...
        "intro": [
            "Metung is a boating village on the Gippsland Lakes, and a good share of the houses are second homes or higher-end waterfront properties. The brief is nearly always a deck that frames the water: a clean balustrade that does not interrupt the outlook, boards that stay presentable without anyone being on site to maintain them, and a pergola or roofed section that makes the space usable when the wind comes off the lake.",
            ...
            "The drive from our Bairnsdale yard is about half an hour, and Metung comes up often enough that we know which aspects cop the worst of it. Salt air and damp go after the fixings and the frame long before they touch the boards you can see, so both get specified for it.",
        ],
        "why_local": ("Built for the wind off the lake.", "Board choice, fixings and how much of the deck to roof, worked out for an exposed Metung waterfront."),
        "faq_local": [
    ...
    },
    {
        ...
        "why_local": ("Ten minutes from the yard.", "Close enough that a shed verandah or a covered area between buildings is worth our while at any size."),
        "faq_local": [
            ...
            ("How far is Nicholson from Bairnsdale?",
             "Only about 10 kilometres east, a 10 to 12 minute drive. Close enough that a Nicholson quote carries essentially nothing for getting there."),
        ],
    ...
    },
    {
        ...
        "intro": [
            "Almost every deck we build at Eagle Point is pointed at the same thing: Lake King and the silt jetties below it. The blocks are generous, waterfront or rural-residential, and most of them fall away towards the water, so the deck is never an afterthought. Most of the work is about getting the living space out towards the view, keeping the balustrade as unobtrusive as the rules allow, and building at a height that suits a block that often falls away towards the water.",
            ...
            "Our yard is 15 minutes north, which matters more on an elevated deck than it sounds: we can come back and check levels part-way through instead of working off one visit. One builder across the whole job, one price agreed before anything starts.",
        ],
        "why_local": ("Local and close.", "Fifteen minutes from the yard, so measuring up a sloping block is a quick trip rather than a scheduled day."),
        "faq_local": [
            ...
            ("How far is Eagle Point from Bairnsdale?",
             "About 15 kilometres south-east, a 15 to 18 minute drive. Close enough that we can come back and check the fall on a stepped deck without it costing you a call-out."),
        ],
    ...
    },
    {
        ...
        "intro": [
            "Lucknow runs off the eastern edge of Bairnsdale, near enough to be town but settled enough to have its own feel. The housing is older homes alongside newer builds, and the decking work splits along exactly that line. Older places often have a deck or verandah at the end of its life, where the boards are still passable but the frame underneath is not, and that is a rebuild rather than a resurface. Newer homes usually want the alfresco area finished properly, with a pergola over it so the space works beyond summer.",
            "A Lucknow job is a few minutes from the yard, and that is the difference between looking at your deck this week and booking you in for a fortnight away. It matters when you are trying to have it finished before Christmas rather than after it.",
        ...
        "why_local": ("On our doorstep.", "Minutes from the yard, so nothing is loaded into the price for getting there and we can look at the job quickly."),
        "faq_local": [
            ...
            ("Are you local to Lucknow?",
             "As local as we get. Lucknow is minutes off the eastern edge of Bairnsdale, so a deck quote here has no travel component in it at all."),
        ],
    ...
    },
    {
        ...
        "intro": [
            "Out on the Mitchell River flats west of Bairnsdale, Lindenow is market-garden country, and what people want built outside follows the land. Homes sit on acreage, often older farmhouses and rural-residential properties. A wide verandah that shades the house through summer does more work on a farm than a compact entertaining deck ever would, and it is usually the first thing we are asked about.",
            ...
            "Our yard is 20 minutes east and the farm blocks around Bairnsdale are part of the normal run, not an exception we make for them. Ten years of verandah posts and pergola footings on open ground is the experience that counts out here, and we finish what we start.",
        ],
        "why_local": ("Rural blocks are normal work.", "Verandah posts and pergola footings sized for open, exposed ground rather than a sheltered town block."),
        "faq_local": [
            ...
            ("How far is Lindenow from Bairnsdale?",
             "About 20 kilometres, a 20 minute drive. The farm blocks west of Bairnsdale are a standing part of our run, so a verandah out here is not a special trip."),
        ],
